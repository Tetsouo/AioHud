...
extern void        aio_plugin_text_in(const char* original, char* modified, int* mode);  // slot 9 (incoming text) : read original + *mode (161 = Omen)
...
static u32 __stdcall m09(P, const char* a, char* b, int* c) { aio_plugin_text_in(a, b, c); return 0; }  // incoming text (original, modified, mode)

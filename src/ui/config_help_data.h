...
static const HelpItem HELP_SKILLCHAINS[] = {
    ...
    {2, "*Elements* toggles each row on its own : the *Title*, the *Timer*, the *Step*, the *Properties* and the continuation *List*.",
        "*Éléments* active chaque rangée séparément : le *Titre*, le *Timer*, le *Step*, les *Propriétés* et la *Liste* de continuation."},

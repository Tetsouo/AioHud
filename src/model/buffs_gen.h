// buffs_gen.h -- GENERATED by scripts/gen_buff_names.py (res/buffs.lua). status id -> name.
#pragma once
namespace aio {
struct BuffRow { unsigned short id; const char* en; };
...
static const int BUFF_NAMES_N = 624;
